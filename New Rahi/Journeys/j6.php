...
<style>
.box{
    background-image: url(../img/banglore5.jpg) ;
}


    @keyframes slider {
    0%{
        background-image: url(../img/banglore1.jpg);
    }

    35%{
        background-image: url(../img/banglore2.jpg);
    }
    75%{
        background-image: url(../img/banglore3.jpg);
    }
}
...
<body>
  ...
  <div class="bg1">
    ...
    <!-- <img src="../img/banglore1.jpg" alt="" class="img2" width="100%" height="100%" > -->
  </div>
</div>
  ...
  <div class="flex">
    ...
    <div class="imgs">
      <div class="row1">
      <img src="../img/banglore1.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/banglore2.jpg" alt="" width="390px" height="330px"  style="border-radius: 20px;">
    </div>
    <div class="row2">
      <img src="../img/banglore3.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/banglore4.jpg" alt="" width="390px" height="330px " style="border-radius: 20px;">
    </div>
    </div>
  ...
  <!-- Animations -->
  <h1 class="h1tag" id="explore">Banglore Tour</h1>
  <div class="textalign">
  <ul>
    
    <li>Bengaluru  is the capital and largest city of the southern Indian state of Karnataka. It has a population of more than 8 million and a metropolitan population of around 11 million, making it the third most populous city and fifth most populous urban agglomeration in India, as well as second largest urban agglomeration in South India.</li><br>

    <li>Lal Bagh is a botanical garden, commissioned by the Hyder Ali in 1760. The 240-acre (0.97 km2) park is home to over 1000 species of flora and a Glass House. The park is known for its annual flower show.</li><br>
    ...
    <br>
    <li>Everest Expedition, the most daunting, challenging and thrilling adventure</li>
     <br>Bangalore is considered to be one of the fastest-growing global major metropolises.[14][15] Recent estimates of the metro economy of its urban area has ranked Bangalore as one of the most productive metro areas of India.</li><br>
