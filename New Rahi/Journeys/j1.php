...
<head>
  ...
  <title>Mount Everest Tours</title>
...
.box{
  ...
  background-size: cover;         /* Image will be cover entire box*/
  background-position: center;
    ...
    75%{
        background-image: url(../img/everest3.jpg);
    }
}
...
<body>
  ...
  <div class="bg1">
    ...
    <!-- <img src="../img/everest1.jpg" alt="" class="img2" width="100%" height="100%" > -->
  </div>
</div>
  ...
  <div class="flex">
    ...
    <div class="imgs">
      <div class="row1">
      <img src="../img/everest1.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/everest2.jpg" alt="" width="390px" height="330px"  style="border-radius: 20px;">
    </div>
    <div class="row2">
      <img src="../img/everest3.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/everest4.jpg" alt="" width="390px" height="330px " style="border-radius: 20px;">
    </div>
    </div>
  ...
  <!-- Animations -->
  <h1 class="h1tag" id="explore">Mount Everest Track</h1>
  <div class="textalign">
  <ul>
    
    <li>Mount Everest is the tallest peak in the world and has attracted many climbers since it was first conquered over a century ago.</li><br>

    <li>The climbing of Mount Everest is considered to be one of the most difficult feats in mountaineering, with the summit being 8,848 meters (29,029 ft.) above sea level. The ascent involves a variety of obstacles including steep slopes, huge ice walls as well as hidden crevasses and sudden weather changes.</li><br>
