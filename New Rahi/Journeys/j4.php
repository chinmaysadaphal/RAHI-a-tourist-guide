...
<style>
.box{
    background-image: url(../img/nepal2.jpg) ;
}


    @keyframes slider {
    0%{
        background-image: url(../img/nepal1.jpg);
    }
    ...
    75%{
        background-image: url(../img/nepal3.jpg);
    }
}
...
<body>
  ...
  <div class="bg1">
    ...
    <!-- <img src="../img/nepal1.jpg" alt="" class="img2" width="100%" height="100%" > -->
  </div>
</div>
  ...
  <div class="flex">
    ...
    <div class="imgs">
      <div class="row1">
      <img src="../img/nepal1.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/nepal2.jpg" alt="" width="390px" height="330px"  style="border-radius: 20px;">
    </div>
    <div class="row2">
      <img src="../img/nepal3.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/nepal4.jpg" alt="" width="390px" height="330px " style="border-radius: 20px;">
    </div>
    </div>
  ...
  <!-- Animations -->
  <h1 class="h1tag" id="explore">Nepal Tours</h1>
  <div class="textalign">
  <ul>
    
    <li>Tourism is the largest industry in Nepal and its largest source of foreign exchange and revenue. </li><br>

    <li> Mountaineering and other types of adventure tourism and ecotourism are important attractions for visitors.</li><br>
    
    <li>According to Nepal's Ministry of Tourism, major tourist activities include wilderness and adventure activities such as mountain biking, bungee jumping, rock climbing and mountain climbing, trekking, hiking, bird watching, flights, paragliding and hot air ballooning over the mountains of Himalaya, exploring the waterways by raft, kayak or canoe and jungle safaris especially in the Terai region.</li><br>
