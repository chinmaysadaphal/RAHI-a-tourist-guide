...
<style>
.box{
    background-image: url(../img/delhi5.jpg) ;
}


    @keyframes slider {
    0%{
        background-image: url(../img/delhi1.jpg);
    }

    35%{
        background-image: url(../img/delhi2.jpg);
    }
    75%{
        background-image: url(../img/delhi3.jpg);
    }
}
...
<body>
  ...
  <div class="bg1">
    ...
    <!-- <img src="../img/delhi1.jpg" alt="" class="img2" width="100%" height="100%" > -->
  </div>
</div>
  ...
  <div class="flex">
    ...
    <div class="imgs">
      <div class="row1">
      <img src="../img/delhi1.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/delhi2.jpg" alt="" width="390px" height="330px"  style="border-radius: 20px;">
    </div>
    <div class="row2">
      <img src="../img/delhi3.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/delhi4.jpg" alt="" width="390px" height="330px " style="border-radius: 20px;">
    </div>
    </div>
  ...
  <!-- Animations -->
  <h1 class="h1tag" id="explore">Delhi Tour</h1>
  <div class="textalign">
  <ul>
    
    <li>ontains the historic core of Delhi, also known as Old Delhi, with major tourist attractions such as the Red Fort and the Jama Masjid. Delhi Junction railway station is here. The red metro line runs east-west here, and the yellow line runs north-south</li><br>

    <li>ravellers with little experience of visiting developing megacities will find Delhi to be chaotic, crowded and for much of the year, polluted. Air pollution is a major problem in Delhi since the 1980s, with much of the day dominated with a very unhealthy amount of particles.</li><br>
    
    <li>Welcome to Makalu Adventure Everest Expedition 2024.</li><br>
    ...
    <br>
    <li>Everest Expedition, the most daunting, challenging and thrilling adventure in the Himalayas; with no doubt thousands of Expedition leaders and climbers climb the world's highest mountain - Mount Everest (8848.86 m).</li>
     <br>Surajkund - Built in the 9th-10th century on what is now the far southern outskirts of Delhi. A large water reservoir can be seen, well preserved.</li><br>
