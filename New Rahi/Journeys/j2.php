...
<style>
.box{
    background-image: url(../img/usa2.jpg) ;
}


    @keyframes slider {
    0%{
        background-image: url(../img/usa1.jpg);
    }
    ...
    75%{
        background-image: url(../img/usa3.jpg);
    }
}
...
<body>
  ...
  <div class="bg1">
    ...
    <!-- <img src="../img/usa1.jpg" alt="" class="img2" width="100%" height="100%" > -->
  </div>
</div>
  ...
  <div class="flex">
    ...
    <div class="imgs">
      <div class="row1">
      <img src="../img/usa1.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/usa2.jpg" alt="" width="390px" height="330px"  style="border-radius: 20px;">
    </div>
    <div class="row2">
      <img src="../img/usa3.jpg" alt="" width="390px" height="330px" style="border-radius: 20px;">
      <img src="../img/usa4.jpg" alt="" width="390px" height="330px " style="border-radius: 20px;">
    </div>
    </div>
  ...
  <h1 class="h1tag" id="explore">USA Tour</h1>
  <div class="textalign">
  <ul>
    
    <li>In the United States, tourism is a large industry that serves millions of international and domestic tourists yearly. Foreigners visit the U.S. to see natural wonders, cities, historic landmarks, and entertainment venues/li><br>

    <li>Tourism in the United States grew rapidly in the form of urban tourism during the late nineteenth and early twentieth centuries. By the 1850s, tourism in the United States was well established both as a cultural activity and as an industry. </li><br>
    
    <li>There exist a broad range of tourist attractions in the United States such as amusement parks, festivals, gambling, golf courses, historical buildings and landmarks, hotels, museums, galleries, outdoor recreation, spas, restaurants and sports</li><br>
    <li>Over 25 years of experience in high altitude expeditions</li>
    <br>
    <li>Democratization of travel occurred during the early twentieth century when the automobile revolutionized travel. Similarly air travel revolutionized travel during 1945–1969, contributing greatly to tourism in the United States..</li>
    <br>
    <li>The travel and tourism industries in the United States were among the first economic sectors negatively affected by the September 11, 2001 attacks.</li>
     <br>Tourists spend more money in the United States than any other country, while attracting the third-highest number of tourists after France and Spain.</li><br>
     <li> MAs American cities developed, new institutions to accommodate and care for the insane, disabled and criminal were constructed.  </li><br>
     <li> The English writer and actress Fanny Kemble was an admirer of the American prison system who was also concerned that nature was being destroyed in favor of new developments. Guidebooks published in the 1830s, 40s and 50s described new prisons, asylums and institutions for the deaf and blind, and urged tourists to visit these sights. </li><br>
     <li> The buildings which housed them were themselves monumental, often placed on hilltops as a symbol of accomplishment.
    </ul>
  </div>
